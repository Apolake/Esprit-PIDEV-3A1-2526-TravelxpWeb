...
#[ORM\Entity(repositoryClass: ActivityWaitingListEntryRepository::class)]
#[ORM\Table(name: 'activity_waiting_list')]
#[ORM\UniqueConstraint(name: 'uniq_activity_waiting_activity_user_status', columns: ['activity_id', 'user_id', 'status'])]
#[ORM\Index(columns: ['status', 'expires_at'], name: 'idx_activity_waiting_status_exp')]
