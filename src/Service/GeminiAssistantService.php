...
class GeminiAssistantService
{
    ...
    private function buildFallbackReply(array $context, string $prompt): string
    {
        ...
        return sprintf(
            'For %s, your current estimate is $%s. Pricing reflects %s and %s. Selected services: %s. Based on your question "%s", compare nearby dates, keep long-stay discounts in mind, and pay when this mix feels right.',
            $property,
