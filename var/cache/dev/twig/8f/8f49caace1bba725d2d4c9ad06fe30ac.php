...
class __TwigTemplate_41805ecd8eb98fde6db4aa0b358d4c60 extends Template
{
    ...
    public function block_title(array $context, array $blocks = []): iterable
    {
        ...
        yield (((($tmp = (isset($context["isAdmin"]) || array_key_exists("isAdmin", $context) ? $context["isAdmin"] : (function () { throw new RuntimeError('Variable "isAdmin" does not exist.', 3, $this->source); })())) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ("Admin Menu - Edit Property") : ("Edit Property"));
    ...
    public function block_body(array $context, array $blocks = []): iterable
    {
        ...
        <h1>Edit property #";
        // line 9
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, (isset($context["property"]) || array_key_exists("property", $context) ? $context["property"] : (function () { throw new RuntimeError('Variable "property" does not exist.', 9, $this->source); })()), "id", [], "any", false, false, false, 9), "html", null, true);
        yield "</h1>

        ";
        // line 11
        yield Twig\Extension\CoreExtension::include($this->env, $context, "property/_form.html.twig", ["button_label" => "Update property"]);
        yield "
        ...
        yield "\">Back to list</a>
            ";
        // line 15
        yield Twig\Extension\CoreExtension::include($this->env, $context, "property/_delete_form.html.twig", ["routePrefix" => (isset($context["routePrefix"]) || array_key_exists("routePrefix", $context) ? $context["routePrefix"] : (function () { throw new RuntimeError('Variable "routePrefix" does not exist.', 15, $this->source); })()), "property" => (isset($context["property"]) || array_key_exists("property", $context) ? $context["property"] : (function () { throw new RuntimeError('Variable "property" does not exist.', 15, $this->source); })())]);
        yield "
        </div>
    </section>
";
...
{% block title %}{{ isAdmin ? 'Admin Menu - Edit Property' : 'Edit Property' }}{% endblock %}

{% block body %}
    {% set routePrefix = isAdmin ? 'admin_property_' : 'property_' %}
    <section class=\"glass-card\">
        <p class=\"eyebrow\">{{ isAdmin ? 'Admin Menu' : 'Front Office' }}</p>
        <h1>Edit property #{{ property.id }}</h1>

        {{ include('property/_form.html.twig', {button_label: 'Update property'}) }}
...
{% endblock %}
", "property/edit.html.twig", "C:\\Users\\nafti\\Downloads\\symfony\\Esprit-PIDEV-3A1-2526-TravelxpWeb\\templates\\property\\edit.html.twig");
    }
}
