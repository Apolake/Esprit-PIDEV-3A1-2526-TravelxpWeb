...
class __TwigTemplate_ac95aae26abf62f96494f641abf16dad extends Template
{
    ...
    public function block_body(array $context, array $blocks = []): iterable
    {
        ...
        // line 6
        yield "    <section class=\"glass-card auth-card\">
        <p class=\"eyebrow\">Community</p>
        <h1>Edit comment</h1>

        ";
        // line 10
        yield Twig\Extension\CoreExtension::include($this->env, $context, "comment/_form.html.twig", ["form" => (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 10, $this->source); })()), "button_label" => "Save comment"]);
        yield "

        <div class=\"row-actions\">
            <a class=\"btn\" href=\"";
        // line 13
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("blog_show", ["id" => CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["comment"]) || array_key_exists("comment", $context) ? $context["comment"] : (function () { throw new RuntimeError('Variable "comment" does not exist.', 13, $this->source); })()), "blog", [], "any", false, false, false, 13), "id", [], "any", false, false, false, 13)]), "html", null, true);
        yield "\">Back to blog</a>
        </div>
    </section>
";
...
{% block body %}
    <section class=\"glass-card auth-card\">
        ...
        {{ include('comment/_form.html.twig', {form: form, button_label: 'Save comment'}) }}

        <div class=\"row-actions\">
            <a class=\"btn\" href=\"{{ path('blog_show', {'id': comment.blog.id}) }}\">Back to blog</a>
        </div>
    </section>
{% endblock %}
", "comment/edit.html.twig", "C:\\Users\\nafti\\Downloads\\symfony\\Esprit-PIDEV-3A1-2526-TravelxpWeb\\templates\\comment\\edit.html.twig");
    }
}
