...
class __TwigTemplate_603fe212ea099b0e96fd8158a0b8c684 extends Template
{
    ...
    public function block_title(array $context, array $blocks = []): iterable
    {
        ...
        yield (((($tmp = (isset($context["isAdmin"]) || array_key_exists("isAdmin", $context) ? $context["isAdmin"] : (function () { throw new RuntimeError('Variable "isAdmin" does not exist.', 3, $this->source); })())) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ("Admin Menu - New Service") : ("New Service"));
    ...
    public function block_body(array $context, array $blocks = []): iterable
    {
        ...
        <p class=\"muted\">Add a new add-on service with validated pricing and availability.</p>
...
{% block title %}{{ isAdmin ? 'Admin Menu - New Service' : 'New Service' }}{% endblock %}
...
{% endblock %}
", "service/new.html.twig", "C:\\Users\\nafti\\Downloads\\symfony\\Esprit-PIDEV-3A1-2526-TravelxpWeb\\templates\\service\\new.html.twig");
    }
}
