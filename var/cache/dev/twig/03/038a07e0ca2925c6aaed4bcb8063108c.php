...
class __TwigTemplate_d949321810b5c7db3cc6c5b696a4c5dd extends Template
{
    ...
    public function block_title(array $context, array $blocks = []): iterable
    {
        ...
        yield (((($tmp = (isset($context["isAdmin"]) || array_key_exists("isAdmin", $context) ? $context["isAdmin"] : (function () { throw new RuntimeError('Variable "isAdmin" does not exist.', 3, $this->source); })())) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ("Admin Menu - New Property") : ("New Property"));
    ...
    public function block_body(array $context, array $blocks = []): iterable
    {
        ...
        <p class=\"muted\">Publish a property listing with full validation.</p>

        ";
        // line 12
        yield Twig\Extension\CoreExtension::include($this->env, $context, "property/_form.html.twig", ["button_label" => "Create property"]);
        yield "
...
";
    ...
    {
        return array (  118 => 14,  113 => 12,  106 => 8,  103 => 7,  100 => 6,  87 => 5,  64 => 3,  41 => 1,);
    }
...
{% block title %}{{ isAdmin ? 'Admin Menu - New Property' : 'New Property' }}{% endblock %}
...
{% block body %}
    ...
    <section class=\"glass-card\">
        ...
        {{ include('property/_form.html.twig', {button_label: 'Create property'}) }}

        <a class=\"btn\" href=\"{{ path(routePrefix ~ 'index') }}\">Back to list</a>
    </section>
{% endblock %}
", "property/new.html.twig", "C:\\Users\\nafti\\Downloads\\symfony\\Esprit-PIDEV-3A1-2526-TravelxpWeb\\templates\\property\\new.html.twig");
    }
}
