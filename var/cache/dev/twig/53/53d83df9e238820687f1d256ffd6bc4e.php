...
class __TwigTemplate_cda45cb9bc9024276b7ef001d20aa2e1 extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        ...
        yield "\" class=\"inline-form\" onsubmit=\"return confirm('Delete this user account?');\">
...
";
    ...
    {
        return new Source("<form method=\"post\" action=\"{{ path('app_user_delete', {'id': user.id}) }}\" class=\"inline-form\" onsubmit=\"return confirm('Delete this user account?');\">
    <input type=\"hidden\" name=\"_token\" value=\"{{ csrf_token('delete' ~ user.id) }}\">
    <button class=\"btn btn-sm btn-danger\">Delete</button>
</form>
", "user/_delete_form.html.twig", "C:\\Users\\nafti\\Downloads\\symfony\\Esprit-PIDEV-3A1-2526-TravelxpWeb\\templates\\user\\_delete_form.html.twig");
    }
}
