 ...
 */
class getQuestRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\QuestRepository' shared autowired service.
     *
     * @return \App\Repository\QuestRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'QuestRepository.php';

        return $container->privates['App\\Repository\\QuestRepository'] = new \App\Repository\QuestRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
