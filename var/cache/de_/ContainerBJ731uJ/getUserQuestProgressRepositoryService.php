 ...
 */
class getUserQuestProgressRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\UserQuestProgressRepository' shared autowired service.
     *
     * @return \App\Repository\UserQuestProgressRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'UserQuestProgressRepository.php';

        return $container->privates['App\\Repository\\UserQuestProgressRepository'] = new \App\Repository\UserQuestProgressRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
